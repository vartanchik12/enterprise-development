...
/// <summary>
/// DTO representing a patient in the system.
/// </summary>
/// <param name="Id">The identifier of the patient.</param>
...
public record PatientDto(int Id, string Passport, string FullName, Sex Sex, DateOnly BirthDate, string? Address, BloodType? BloodType, RHFactor? RHFactor, string? PhoneNumber);